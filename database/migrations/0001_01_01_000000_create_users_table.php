...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('users', function (Blueprint $table) {
            ...
            // HAPUS $table->foreignId('role_id') karena manajemen role sudah diambil alih Spatie lewat tabel pivot
            $table->rememberToken();
            $table->timestamps();
        });

        // Tabel password_reset_tokens & sessions di bawahnya biarkan saja tetap sama...
